WORKFLOW_OPTIMIZE_PROMPT = """You are building a Graph and corresponding Prompt to jointly solve {category} problems. 
Referring to the given graph and prompt, which forms a basic example of a {category} solution approach, 
